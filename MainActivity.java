package com.example.randommath;
        ...
        answerButton.setOnClickListener(new View.OnClickListener(){
			...
			public void onClick(View v) {
				...
				if(answer.getText().length()>3){
					...
					new AlertDialog.Builder(MainActivity.this).setMessage("Impossible answer, try again")
				...
				uAnswer = Integer.parseInt(answer.getText().toString());
				 if(isCorrect(uAnswer)){
					...
					new AlertDialog.Builder(MainActivity.this).setMessage("Correct!")
					.setPositiveButton("OK", new DialogInterface.OnClickListener() {
					...
					new AlertDialog.Builder(MainActivity.this).setMessage("Incorrect, try again.")
					.setPositiveButton("OK",new DialogInterface.OnClickListener(){
